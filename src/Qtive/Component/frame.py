...
from ..Props.events import OnUpdate
from ..Props.content import Attributes
from .helpers import separate_size, DraggableHelper
from math import floor


class Frame(QFrame, Static, Component, Container):
    ...
    def assign_props(self, args):
        ...
        if onupdate := self.props.get("onupdate"):
            self.drag = DraggableHelper(self)
            self.drag.position.connect(onupdate)
